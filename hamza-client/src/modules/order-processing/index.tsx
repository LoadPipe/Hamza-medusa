            ...
            >
                <AlertDialogOverlay>
                    <AlertDialogContent bg="gray.800" color="white">
                        ...
                        <AlertDialogBody>
                            Are you sure you want to cancel this payment? This
                            action cannot be undone. You will be redirected back
                            to your cart and can restart the checkout process
                            later.
                        </AlertDialogBody>
                                ...
                                {paywith && paywith === 'bitcoin' ? (
                                    <>
                                        ...
                                        >
                                            ...
                                            complete your payment, simply scan
                                            the QR code using your Bitcoin
                                            wallet.
                                        </Text>
