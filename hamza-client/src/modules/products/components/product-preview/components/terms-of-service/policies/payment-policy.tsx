...
const PaymentPolicy = () => {
    return (
        <TabPanel>
            ...
            <Text>
                • Sellers may be subject to a small transaction fee on each
            ...
            <Text>
                • If only a partial refund is requested and approved, the same
            ...
            <Text>
                • If the cryptocurrency wallet does not have enough funds to
            ...
            <Text>
                ...
                regarding the use of cryptocurrency for payments.
            </Text>
        </TabPanel>
    );
};
