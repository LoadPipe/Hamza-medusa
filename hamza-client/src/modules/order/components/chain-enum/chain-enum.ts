...
export const chainIdToName = (id: number): string => {
    ...
    return Object.entries(ChainNames).find(([, value]) => value === id)?.[0] || 'Unknown Chain';
};
...
export const getChainLogo = (id: number): string => {
    const logos: Record<number, string> = {
        ...
        11155111: "https://lh3.googleusercontent.com/ubGeGKiOxh9hwvu1EtDedfpl0Mry7JXD-iiPyAtRo9oVYLTpuGInHowVhNgPPPH_PajRzTVDJ68iOGuXUjXyOBU=w16383", // Sepolia (fallback to Ethereum)
        11155420: "https://cryptologos.cc/logos/optimism-ethereum-op-logo.png?v=029", // OpSepolia (OP LOGO...)
        80002: "https://cryptologos.cc/logos/polygon-matic-logo.png?v=029", // Amoy (fallback to Polygon)
    };

    return logos[id] || "https://cryptologos.cc/logos/ethereum-eth-logo.png?v=029"; // Default to Ethereum logo
};
